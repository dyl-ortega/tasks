...
export function findQuestion(
    ...
    const foundQuestion = questions.find((question: Question) => question.id === id);
...
export function sumPoints(questions: Question[]): number {
    return questions.reduce((points: number, question: Question) => points + question.points, 0);
}
...
export function sumPublishedPoints(questions: Question[]): number {
    return questions.reduce((points:number, question: Question) => 
        question.published ? points + question.points : points, 0);
}
...
export function toCSV(questions: Question[]): string {
    const csvQuestions = questions.map((question : Question): string => 
        `${question.id},${question.name},${question.options.length},${question.points},${question.published}`).join("\n");
    return ["id,name,options,points,published", csvQuestions].join("\n");
}
...
export function sameType(questions: Question[]): boolean {
    ...
    return questions.every((question: Question) => question.type === questionType);
}
...
export function editOption(
    ...
    return questions.map((question: Question) => {
        ...
        const newOptions = targetOptionIndex === -1 ? [...question.options, newOption]
